...
const FuelResults = ({ results }) => {
 ...
 <img src="${logoURL}" class="header-image" alt="Logo"/>
        ...
        <div class="row total-row">
          ...
          <div class="cell"><p class="cell-text">${results.namayeshQ}</p></div>
        </div>
        <div class="row total-row">
    ...
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <View style={styles.table}>
        ...
        <View style={styles.totals}>
          ...
          <View style={styles.row}>
            <View style={styles.cell}><Text style={styles.cellText}>کسری غیر مجاز بنزین: {results.namayeshQ}</Text></View>
          </View>
          <View style={styles.row}>
